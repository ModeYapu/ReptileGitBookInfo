namespace HAPExplorer
{
    ...
    public class HtmlAttributeViewer : UserControl, IComponentConnector
    {
        ...
        {
            HtmlAttribute dataContext = base.DataContext as HtmlAttribute;
            if (dataContext != null)
            {
                if (dataContext.OwnerDocument.DocumentNode.SelectSingleNode(dataContext.XPath) == dataContext.OwnerNode)
                {
        ...
        public void InitializeComponent()
        {
            if (!this._contentLoaded)
            {
                ...
                Uri resourceLocator = new Uri("/HAPExplorer;component/htmlattributeviewer.xaml", UriKind.Relative);
